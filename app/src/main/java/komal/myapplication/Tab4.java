...
public class Tab4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnSubmit = (Button) v.findViewById(R.id.iSearch_4);
        editSearch = (EditText) v.findViewById(R.id.iText_4);
        aexplain = (TextView) v.findViewById(R.id.iExplain_4);
        apropose = (TextView) v.findViewById(R.id.iPropose_4);

        btnSearchspeech = (FloatingActionButton) v.findViewById(R.id.iSearchspeech_4);

        final DataBaseCICS myDbHelper = new DataBaseCICS(getActivity().getApplicationContext());
                ...
                if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
                    ...
                    if (editSearch.getText().toString().length() == 0) {
                        ...
                        Cursor cur = db.rawQuery(
                                "SELECT * from cics where field1=? or field1=?;",
...
//				myDbHelper.close();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CODE && resultCode == getActivity().RESULT_OK) {
            ...
            final DataBaseCICS myDbHelper = new DataBaseCICS(
